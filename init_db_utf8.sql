-- ============================================================
-- Library Catalog Database - PostgreSQL
-- Clean version: no Russian comments, UTF-8
-- ============================================================
...
CREATE TABLE books (
    ...
    udk VARCHAR(20),
    publication_year INTEGER CHECK (publication_year > 0 AND publication_year <= EXTRACT(YEAR FROM CURRENT_DATE) + 1),
...
(1, 1), (2, 2), (3, 3), (4, 3), (5, 4), (6, 5), (7, 2), (8, 1), (9, 5), (10, 4);

INSERT INTO book_genres (book_id, genre_id) VALUES
(1, 1), (1, 3), (2, 1), (2, 2), (2, 3), (3, 4), (3, 3), (4, 4), (4, 6), (5, 1), (5, 6), (5, 3), (6, 5), (7, 1), (7, 2), (7, 3), (8, 1), (8, 3), (9, 5), (10, 6), (10, 3);
